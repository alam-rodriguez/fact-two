...
const Perfil = ({handleClickBack, clienteActivo}) => {
  ...
  return (
    <div className='position-absolute min-vh-100 z-1 bg-black bg-opacity-25' onClick={handleClickAtras}>
            
      <div className='col-9 min-vh-100 border shadow-lg bg-light top-0 start-0 mx-auto' style={{}}>
